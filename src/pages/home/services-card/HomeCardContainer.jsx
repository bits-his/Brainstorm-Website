  ...
  return (
    <>
      <div className="row service-container my-5 py-5" id="services" ref={refi}>
        <Scroll title={"Our Core Competencies"} page="Services" />
        <HomeCard
          heading="Public Financial Management"
          describtion="Comprehensive software solutions for government institutions to manage public finances effectively and maintain financial oversight."
          img={WD}
          time={100}
        />
        <HomeCard
