...
import kasuwamall from "../../assets/logos/KASUWAMALL_2-removebg-preview.png";
      ...
      <div className="container-fluid styled">
        <div className="row">
          <Row>
            ...
            <Col md={4}>
              {/* <Link to="https://pharmpay.brainstorm.ng/"> */}
                <CustumeCard
                  handlebtnclick="https://pharmpay.brainstorm.ng/"
                  alt="Pharmpay"
                  image={pharmpay}
                  title="Pharmpay"
                  text="
