    ...
    <div className=" my-5" id="service" >
      ...
      <div className="row service-container" id='service'>
        ...
        {/* <Card
          ...
          We specialize in creating dynamic and user-friendly web solutions 
        ...
        <Card
          ...
          tailored to your unique needs. Our software development expertise 
          ensures scalable and efficient solutions."
          img={CSD}
          time={200}
        />
        <Card
          ...
          describtion="
          In addition to our development services, we offer corporate 
          training programs designed to enhance the skills and capabilities 
          of your team. From the latest technologies to industry best practices."
          img={CT}
          time={250}
        />
        <Card
          ...
          describtion="
          Struggling with technology decisions? Our experts offer strategic consultation 
          to help you make informed choices, aligning your technology investments with your 
          business goals."
          img={SC}
          time={300}
        />
        {/* <Card
          ...
          services cover iOS and Android platforms, ensuring your brand reaches 
        ...
        {/* <Card
          ...
          decentralized data management, and enhanced traceability. Our blockchain solutions 
          are designed to streamline and enhance security."
          img={BC}
          time={400}
        /> */}
        {/* <Card
          heading="Software Modernization"
          describtion="We revitalize legacy systems, enhancing performance, security, 
          and user experiences. Our software modernization approach ensures seamless transitions, 
          keeping your software at the forefront of industry standards."
          img={SM}
          time={450}
        /> */}
        <Card
        ...
        {/* <Card
          heading="DevOps"
          describtion="We enable faster, more reliable software delivery 
          by integrating development and operations seamlessly. Our DevOps 
          services optimize your workflow, fostering innovation and continuous improvement."
          img={DO}
          time={550}
        /> */}
      </div>
